 ...
 * Matches the ClassSense design-system spec without adding the
...
export function GraduationCap({ size = 18, className, strokeWidth = 1.5 }: Props) {
  return (
    <svg {...base(size, strokeWidth, className)}>
      <path d="M22 10 12 5 2 10l10 5 10-5z" />
      <path d="M6 12v5c0 1.1 2.7 2 6 2s6-.9 6-2v-5M22 10v6" />
    </svg>
  );
}
